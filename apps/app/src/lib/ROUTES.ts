...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/account/profile': never, '/account/settings': never, '/debug': never, '/debug/editor': never, '/auth/log-in': never, '/auth/mfa': never, '/auth/recovery-code': never, '/auth/reset-password': never, '/auth/sign-up': never }
  SERVERS: { 'POST /api/assets': never, 'PUT /api/assets': never, 'GET /api/assets': never, 'DELETE /api/assets': never, 'GET /robots.txt': never, 'GET /auth/sign-out': never, 'GET /auth/verify-email': never, 'GET /oauth/[provider]': 'provider', 'GET /oauth/[provider]/callback': 'provider' }
  ACTIONS: { 'default /auth/log-in': never, 'default /auth/mfa': never, 'default /auth/sign-up': never }
