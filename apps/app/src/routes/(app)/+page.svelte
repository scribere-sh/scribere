<script lang="ts">
    ...
    // import * as Footer from '@scribere/ui/app-footer'

    const CARD_TRANSPARENT = false;
...
<div class="h-full py-12">
    <Card.Root
        class={cn(
            "border-none w-[1200px] h-[200vh]  mx-auto",
            CARD_TRANSPARENT 
                ? "bg-transparent shadow-none"
                : "bg-card/90 supports-[backdrop-filter]:bg-card/70 backdrop-blur-lg"
        )}
    >
        <Card.Header>
